...
public class StudentDAOTest {
    ...
    public void setUp() {
        ...
        dao = JdbiDaoFactory.getStudentDAO();

        s1 = new Student(1111, "S1_NAME", "S1_ADDRESS", "S1_PHONE", "INFO");
        s2 = new Student(2222, "S2_NAME", "S2_ADDRESS", "S2_PHONE", "COSC");
        s3 = new Student(3333, "S3_NAME", "S3_ADDRESS", "S3_PHONE", "COSC");
    ...
    public void testGetAll() {
        ...
        Student result = students.stream()
            .filter(s -> s.getId().equals(s1.getId())).findFirst().get();
